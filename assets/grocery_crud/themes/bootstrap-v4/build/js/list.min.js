...
}, CacheLibrary.prototype.setLocalStorageItem = function(a, b) {}, CacheLibrary.prototype.removeLocalStorageItem = function(a) {}, CacheLibrary.prototype.getLocalStorageItem = function(a) {
    return null
}, CacheLibrary.prototype.setLocalStorageCache = function() {
    this.browserSupportsLocalStorage() && (this.setLocalStorageItem = function(a, b) {
        localStorage.setItem(a, b)
    }, this.removeLocalStorageItem = function(a) {
        localStorage.removeItem(a)
    }, this.getLocalStorageItem = function(a) {
        return localStorage.getItem(a)
    })
}, CacheLibrary = new CacheLibrary, CacheLibrary.setLocalStorageCache();
...
function(a) {
    ...
    }, "undefined" != typeof document && a(document).on("click.bs.dropdown.data-api", c).on("click.bs.dropdown.data-api", f, g.prototype.toggle).on("keydown.bs.dropdown.data-api", f, g.prototype.keydown).on("keydown.bs.dropdown.data-api", ".dropdown-menu", g.prototype.keydown)
}(jQuery); +
function(a) {
    "use strict";
    ...
    c.VERSION = "3.3.6", c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        this.$element.trigger(e), this.isShown || e.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass("modal-open"), this.escape(), this.resize(), this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', a.proxy(this.hide, this)), this.$dialog.on("mousedown.dismiss.bs.modal", function() {
            ...
            d.$element.parent().length || d.$element.appendTo(d.$body), d.$element.show().scrollTop(0), d.adjustDialog(), e && d.$element[0].offsetWidth, d.$element.addClass("in"), d.$element.addClass("show"), d.enforceFocus();
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = a(document.createElement("div")).addClass("modal-backdrop " + e).appendTo(this.$body), this.$element.on("click.dismiss.bs.modal", a.proxy(function(a) {
                ...
                }, this)), f && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), this.$backdrop.addClass("show"), !b) return;
            f ? this.$backdrop.one("bsTransitionEnd", b).emulateTransitionEnd(c.BACKDROP_TRANSITION_DURATION) : b()
        } else if (!this.isShown && this.$backdrop) {
            this.$backdrop.removeClass("in"), this.$backdrop.removeClass("show");
            var g = function() {
    ...
    }, a.fn.gc_modal = b, a.fn.gc_modal.Constructor = c, "undefined" != typeof document && a(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(c) {
        var d = a(this),
            e = d.attr("href"),
...
(function(e, t, n, r) {
    ...
    var u = function(t, n) {
        ...
        f = function(t, n, r) {
            ...
            $template = l(i);
            c($template, i.settings);
            h($template, i.settings);
            p($template, i.settings, r)
        },
        l = function(t) {
        ...
        h = function(t, n) {
            ...
            switch (n.placement.align) {
                case "center":
                    ...
                    break;
                case "left":
                    t.css("left", n.offset + "px");
                    break;
                case "right":
                    t.css("right", n.offset + "px");
                    break
            }
    ...
    var b;
    a.fn.printThis = function(c) {
        b = a.extend({}, a.fn.printThis.defaults, c);
        ...
        if (window.location.hostname !== document.domain && navigator.userAgent.match(/msie/i)) {
            ...
            g.name = "printIframe", g.id = e, g.className = "MSIE", document.body.appendChild(g), g.src = f
        } else {
            a("<iframe id='" + e + "' name='printIframe' />").appendTo("body")
        }
        var h = a("#" + e);
        b.debug || h.css({
            position: "absolute",
            ...
            var c = h.contents();
            if (b.importCSS && a("link[rel=stylesheet]").each(function() {
                    var b = a(this).attr("href");
                    if (b) {
                        var d = a(this).attr("media") || "all";
                        c.find("head").append("<link type='text/css' rel='stylesheet' href='" + b + "' media='" + d + "'>")
                    }
                }), b.pageTitle && c.find("head").append("<title>" + b.pageTitle + "</title>"), b.loadCSS && c.find("head").append("<link type='text/css' rel='stylesheet' href='" + b.loadCSS + "'>"), b.header && c.find("body").append(b.header), b.printContainer ? c.find("body").append(d.outer()) : d.each(function() {
                    c.find("body").append(a(this).html())
                }), b.formValues) {
                var e = d.find("input");
                e.length && e.each(function() {
                    var b = a(this),
                        d = a(this).attr("name"),
                        e = b.is(":checkbox") || b.is(":radio"),
                        f = c.find("input[name=" + d + "]"),
                        g = b.val();
                    e ? b.is(":checked") && (b.is(":checkbox") ? f.attr("checked", "checked") : b.is(":radio") && c.find("input[name=" + d + "][value=" + g + "]").attr("checked", "checked")) : f.val(g)
                });
                var f = d.find("select");
                f.length && f.each(function() {
                    var b = a(this),
                        d = a(this).attr("name"),
                        e = b.val();
                    c.find("select[name=" + d + "]").val(e)
                });
                var g = d.find("textarea");
                g.length && g.each(function() {
                    var b = a(this),
                        d = a(this).attr("name"),
                        e = b.val();
                    c.find("textarea[name=" + d + "]").val(e)
                })
            }
            b.removeInline && (a.isFunction(a.removeAttr) ? c.find("body *").removeAttr("style") : c.find("body *").attr("style", "")), setTimeout(function() {
                h.hasClass("MSIE") ? (window.frames.printIframe.focus(), c.find("head").append("<script>  window.print(); <\/script>")) : (h[0].contentWindow.focus(), h[0].contentWindow.print()), d.trigger("done"), b.debug || setTimeout(function() {
                    h.remove()
                }, 1e3)
            }, b.printDelay)
        }, 333)
        ...
        return a(a("<div></div>").html(this.clone())).html()
    }
}(jQuery);
! function(a) {
    "use strict";
    var b = function(a) {
        this.gcrud_container = a, this.search_timer = null, this.csrf_field = null, this.init = function() {
            this.facadeInitListeners()
        }, this.facadeInitListeners = function() {
            this.datagridInit(), this.listenerSelectRow(), this.listenerLoadMoreButton(), this.listenerDeleteMultiple(), this.listenerDeleteRowClick(), this.listenerSearchInput(), this.listenerColumnWithOrdering(), this.listenerRefreshButton(), this.listenerPrintButton(), this.listenerExportButton(), this.listenerPerPage(), this.listenerPagingButtons(), this.listenerSettingsButton(), this.checkCachedData(), this.pagingCalculations()
        }
    };
    b.SELECTOR_PAGING_PREVIOUS = ".paging-previous", b.SELECTOR_PAGING_NEXT = ".paging-next", b.SELECTOR_PAGING_FIRST = ".paging-first", b.SELECTOR_PAGING_LAST = ".paging-last", b.CLASS_DISABLED = "disabled", b.CLASS_LOADING = "loading-opacity", b.CLASS_PAGING_PREVIOUS = "paging-previous", b.CLASS_PAGING_NEXT = "paging-next", b.CLASS_PAGING_FIRST = "paging-first", b.CLASS_PAGING_LAST = "paging-last", b.CLASS_PER_PAGE = "per_page", b.prototype.clearFilteringCache = function() {
        this.gcrud_container.find(".page-number-hidden").val("1"), this.gcrud_container.find(".page-number-input").val("1"), this.gcrud_container.find(".grocery-crud-table tr:first").find(".active").removeClass("active table-active ordering-desc ordering-asc"), this.gcrud_container.find(".grocery-crud-table tr:first").find(".fa-chevron-up,.fa-chevron-down,.el-chevron-up,.el-chevron-down").remove(), this.gcrud_container.find("td.active").removeClass("active table-active"), this.gcrud_container.find("thead .value-not-empty").removeClass("value-not-empty").val(""), this.SearchAndOrderingTrigger(), CacheLibrary.removeLocalStorageItem("gcrud_" + unique_hash)
    }, b.prototype.checkCachedData = function() {
        var c = this.gcrud_container.find("." + b.CLASS_PER_PAGE).val(),
            d = CacheLibrary.getLocalStorageItem("gcrud_" + unique_hash),
            e = !1;
        try {
            d = null !== d ? JSON.parse(d) : {}
        } catch (a) {
            return CacheLibrary.removeLocalStorageItem("gcrud_" + unique_hash), !1
        }
        if (void 0 === d.per_page || void 0 === d.page || void 0 === d.order_by) return CacheLibrary.removeLocalStorageItem("gcrud_" + unique_hash), !1;
        if (c !== d.per_page && (this.gcrud_container.find("." + b.CLASS_PER_PAGE).val(d.per_page), e = !0), "1" !== d.page && (this.gcrud_container.find(".page-number-hidden").val(d.page), this.gcrud_container.find(".page-number-input").val(d.page), e = !0), null !== d.order_by[0]) {
            var f = this.gcrud_container.find(".grocery-crud-table tr:first").find(".column-with-ordering[data-order-by=" + d.order_by[0] + "]").addClass("active table-active ordering-" + d.order_by[1]),
                g = "asc" === d.order_by[1] ? "fa-chevron-up el-chevron-up" : "fa-chevron-down el-chevron-down";
            f.html("<div>" + f.text() + "</div><i class='fa el " + g + "'></i>"), e = !0
        }
        if (d.search_text && d.search_text.length > 0) {
            var h = this.gcrud_container.find(".gc-search-row");
            a.each(d.search_field, function(a, b) {
                h.find('input.searchable-input[name="' + b + '"]').val(d.search_text[a])
            }), e = !0
        }
        e && this.SearchAndOrderingTrigger()
    }, b.prototype.datagridInit = function() {
        var b, c = this.gcrud_container.find(".success-message");
        c.is(":empty") || a.growl(c.html(), {
            type: "success",
            delay: 1e4,
            animate: {
        ...
        }), b = a("#gcrud-search-form>input[type=hidden]:first"), 1 === b.length && (this.csrf_field = {
            name: b.attr("name"),
            value: b.val(),
            csrf_cookie_name: csrf_cookie_name
        }, void 0 !== this.csrf_field.name && void 0 !== this.csrf_field.value || (this.csrf_field = null))
    }, b.prototype.appendSearchClearButtons = function() {
        var b = this;
        b.gcrud_container.find(".clear-search").remove(), b.gcrud_container.find(".grocery-crud-table input.searchable-input").each(function() {
            if (a(this).removeClass("value-not-empty"), "" === a(this).val()) return !0;
            a(this).addClass("value-not-empty"), a(this).after('<i class="fa fa-times el el-remove clear-search"></i>'), b.gcrud_container.find(".clear-search").click(function() {
                a(this).closest("td").find(".searchable-input").val("").trigger("keyup")
            })
        })
    }, b.prototype.listenerRefreshButton = function() {
        var a = this;
        a.gcrud_container.find(".gc-refresh").click(function() {
            clearTimeout(a.search_timer), a.SearchAndOrderingTrigger()
        })
    }, b.prototype.listenerPerPage = function() {
        var a = this;
        a.gcrud_container.find("." + b.CLASS_PER_PAGE).change(function() {
            a.gcrud_container.find(".page-number-hidden").val("1"), a.SearchAndOrderingTrigger()
        })
    }, b.prototype.setCsrfValue = function() {
        this.csrf_field.value = getCookie(this.csrf_field.csrf_cookie_name)
    }, b.prototype.listenerExportButton = function() {
        var b = this;
        b.gcrud_container.find(".gc-export").click(function() {
            var c = a(this).data("url"),
                d = "";
            a.each(b.gcrud_container.find("form").serializeArray(), function(a, b) {
                d = d + '<input type="hidden" name="' + b.name + '" value="' + b.value + '">'
            }), null !== b.csrf_field && (b.setCsrfValue(), d += '<input type="hidden" name = "' + b.csrf_field.name + '" value="' + b.csrf_field.value + '"/>'), b.gcrud_container.find(".grocery-crud-table thead input").each(function() {
                "" === a(this).val() || a(this).is(":checkbox") || (d = d + '<input type="hidden" name="search_field[]" value="' + a(this).attr("name") + '"><input type="hidden" name="search_text[]" value="' + a(this).val() + '">')
            }), a("#tmp-form").remove(), a("body").after(a("<form/>").attr("id", "tmp-form").attr("method", "post").attr("target", "_blank").attr("action", c).html(d)), a("#tmp-form").submit()
        })
    }, b.prototype.listenerPrintButton = function() {
        var c = this;
        c.gcrud_container.find(".gc-print").click(function() {
            var d, e = a(this).data("url"),
                f = "";
            null !== c.csrf_field && (c.setCsrfValue(), f += '<input type="hidden" name = "' + c.csrf_field.name + '" value="' + c.csrf_field.value + '"/>'), c.gcrud_container.find(".grocery-crud-table thead input").each(function() {
                "" === a(this).val() || a(this).is(":checkbox") || (f = f + '<input type="hidden" name="search_field[]" value="' + a(this).attr("name") + '"><input type="hidden" name="search_text[]" value="' + a(this).val() + '">')
            }), d = a("<form/>").attr("method", "post").attr("action", e).html(f), d.ajaxSubmit({
                beforeSend: function() {
                    c.gcrud_container.addClass(b.CLASS_LOADING)
                },
                complete: function() {
                    c.gcrud_container.removeClass(b.CLASS_LOADING)
                },
                error: function() {
                    c.gcrud_container.removeClass(b.CLASS_LOADING)
                },
                success: function(d) {
                    c.gcrud_container.removeClass(b.CLASS_LOADING), a("<div/>").html(d).printThis()
                }
            })
        })
    }, b.prototype.pagingCalculations = function() {
        var a = parseInt(this.gcrud_container.find(".page-number-hidden").val(), 10),
            c = this.getMaxPaging();
        a <= 0 && (a = 1, this.gcrud_container.find(".page-number-hidden").val("1"), this.gcrud_container.find(".page-number-input").val("1")), 1 === a ? (this.gcrud_container.find(".paging-first").addClass(b.CLASS_DISABLED), this.gcrud_container.find(".paging-previous").addClass(b.CLASS_DISABLED)) : (this.gcrud_container.find(".paging-first").removeClass(b.CLASS_DISABLED), this.gcrud_container.find(".paging-previous").removeClass(b.CLASS_DISABLED)), a + 1 > c ? (this.gcrud_container.find(".paging-last").addClass(b.CLASS_DISABLED), this.gcrud_container.find(".paging-next").addClass(b.CLASS_DISABLED)) : (this.gcrud_container.find(".paging-last").removeClass(b.CLASS_DISABLED), this.gcrud_container.find(".paging-next").removeClass(b.CLASS_DISABLED)), this.gcrud_container.find(".page-number-input").val(a), a > c && (this.gcrud_container.find(".page-number-hidden").val(c), this.gcrud_container.find(".page-number-input").val(c))
    }, b.prototype.datagridOnAjaxComplete = function(c) {
        var d, e, f = this.gcrud_container.find("." + b.CLASS_PER_PAGE).val();
        this.gcrud_container.find(".select-all-none").prop("checked", !1), this.gcrud_container.find(".grocery-crud-table tbody").html(c.tbody_html), a(".current-total-results").html(c.current_total_results), c.current_total_results > 10 ? (e = parseInt(a('input[name="page_number"]').val(), 10) * f, e > c.current_total_results && (e = c.current_total_results), a(".paging-ends").html(e)) : a(".paging-ends").html(c.current_total_results), a(".paging-starts").html((parseInt(a('input[name="page_number"]').val(), 10) - 1) * f + 1), d = a(".column-with-ordering.active:first"), d.length > 0 && this.gcrud_container.find(".grocery-crud-table").find("thead tr td:nth-child(" + (d.index() + 2) + "), tbody tr td:nth-child(" + (d.index() + 2) + ")").addClass("active table-active"), c.current_total_results < parseInt(this.gcrud_container.find(".full-total").html(), 10) ? this.gcrud_container.find(".full-total-container").removeClass("hidden") : this.gcrud_container.find(".full-total-container").addClass("hidden"), this.listenerLoadMoreButton(), this.appendSearchClearButtons(), this.listenerSelectRow(), this.pagingCalculations(), this.hideShowDeleteButton(), this.listenerDeleteRowClick(), this.listenerFancybox()
    }, b.prototype.listenerFancybox = function() {
        a(".image-thumbnail").length > 0 && a(".image-thumbnail").fancybox({
    ...
    }, b.prototype.SearchAndOrderingTrigger = function() {
        var c, d = a(".column-with-ordering.active:first").data("order-by"),
            e = "",
            f = [],
            g = [],
            h = this,
            i = h.gcrud_container;
        h.gcrud_container.find("." + b.CLASS_PER_PAGE).val();
        this.pagingCalculations(), a(".column-with-ordering.active:first").hasClass("ordering-desc") ? e = "desc" : a(".column-with-ordering.active:first").hasClass("ordering-asc") && (e = "asc"), a(".gc-search-row input.searchable-input").each(function() {
            "" !== a(this).val() && (f.push(a(this).attr("name")), g.push(a(this).val()))
        }), c = {
            page: i.find('input[name="page_number"]').val(),
            per_page: i.find("." + b.CLASS_PER_PAGE).val(),
            order_by: [d, e],
            search_field: f,
            search_text: g
        }, CacheLibrary.setLocalStorageItem("gcrud_" + unique_hash, JSON.stringify(c)), this.sendAjaxPost(c, ajax_list_url, this.datagridOnAjaxComplete.bind(this))
    }, b.prototype.listenerSearchInput = function() {
        var b = this;
        a(".grocery-crud-table input.searchable-input").on("keyup change", function(c) {
            var d = 9 === c.keyCode || 13 === c.keyCode || "" === a(this).val() ? 1 : 1e3;
            clearTimeout(b.search_timer), b.search_timer = setTimeout(function() {
                b.gcrud_container.find(".page-number-hidden").val("1"), b.SearchAndOrderingTrigger()
            }, d)
        })
    }, b.prototype.listenerSettingsButton = function() {
        var b = this;
        this.gcrud_container.find(".settings-button-container").on("show.bs.dropdown", function() {
            b.clearFilteringListener(a(this))
        }).on("hide.bs.dropdown", function() {
            a(this).find(".clear-filtering").unbind("click")
        })
    }, b.prototype.clearFilteringListener = function(a) {
        var b = this;
        a.find(".clear-filtering").click(function() {
            b.clearFilteringCache()
        })
    }, b.prototype.listenerColumnWithOrdering = function() {
        var c = this;
        a(".column-with-ordering").click(function() {
            var d = a(this).closest(".gc-container"),
                e = a.trim(a(this).text());
            d.addClass(b.CLASS_LOADING), a(this).closest(".grocery-crud-table").find("th.active, td.active").removeClass("active table-active"), a(this).parent().find(".column-with-ordering").each(function() {
                a(this).html(a.trim(a(this).text()))
            }), a(this).addClass("active table-active"), a(this).closest(".grocery-crud-table").find("thead tr td:nth-child(" + (a(this).index() + 2) + "), tbody tr td:nth-child(" + (a(this).index() + 2) + ")").addClass("active table-active"), a(this).hasClass("ordering-asc") ? (a(this).closest(".grocery-crud-table").find("th").removeClass("ordering-desc").removeClass("ordering-asc"), a(this).html("<div>" + e + "</div><i class='fa el fa-chevron-down el-chevron-down'></i>"), a(this).addClass("ordering-desc").removeClass("ordering-asc")) : (a(this).closest(".grocery-crud-table").find("th").removeClass("ordering-desc").removeClass("ordering-asc"), a(this).html("<div>" + e + "</div><i class='fa el fa-chevron-up el-chevron-up'></i>"), a(this).addClass("ordering-asc").removeClass("ordering-desc")), d.find('input[name="page_number"]').val("1"), d.removeClass(b.CLASS_LOADING), c.SearchAndOrderingTrigger()
        })
    }, b.prototype.listenerSearchButton = function() {}, b.prototype.getMaxPaging = function() {
        var a = parseInt(this.gcrud_container.find(".current-total-results").html(), 10),
            c = parseInt(this.gcrud_container.find("." + b.CLASS_PER_PAGE).val(), 10);
        return 0 === a ? 1 : Math.ceil(a / c)
    }, b.prototype.listenerPagingButtons = function() {
        var c = this,
            d = b.SELECTOR_PAGING_PREVIOUS + ", " + b.SELECTOR_PAGING_NEXT + ", " + b.SELECTOR_PAGING_FIRST + "," + b.SELECTOR_PAGING_LAST,
            e = c.gcrud_container.find(".page-number-hidden");
        this.gcrud_container.find(d).click(function(d) {
            d.preventDefault(), a(this).hasClass(b.CLASS_DISABLED) || (a(this).hasClass(b.CLASS_PAGING_PREVIOUS) ? e.val(parseInt(e.val(), 10) - 1) : a(this).hasClass(b.CLASS_PAGING_NEXT) ? e.val(parseInt(e.val(), 10) + 1) : a(this).hasClass(b.CLASS_PAGING_FIRST) ? e.val("1") : a(this).hasClass(b.CLASS_PAGING_LAST) && e.val(c.getMaxPaging()), c.SearchAndOrderingTrigger())
        }), this.gcrud_container.find(".page-number-input").change(function() {
            isNaN(parseInt(a(this).val(), 10)) ? e.val("1") : e.val(parseInt(a(this).val(), 10)), c.SearchAndOrderingTrigger()
        })
    }, b.prototype.listenerSelectRow = function() {
        var b = this;
        b.gcrud_container.find(".select-row").click(function() {
            a(this).is(":checked") ? a(this).closest("tr").addClass("warning table-warning") : a(this).closest("tr").removeClass("warning table-warning"), b.hideShowDeleteButton()
        })
    }, b.prototype.hideShowDeleteButton = function() {
        this.gcrud_container.find(".select-row:checked").length > 0 ? this.gcrud_container.find(".delete-selected-button").removeClass("hidden") : this.gcrud_container.find(".delete-selected-button").addClass("hidden")
    }, b.prototype.sendAjaxPost = function(c, d, e) {
        null !== this.csrf_field && (this.setCsrfValue(), c[this.csrf_field.name] = this.csrf_field.value), a.ajax({
            beforeSend: function() {
                this.gcrud_container.addClass(b.CLASS_LOADING)
            }.bind(this),
            data: c,
            dataType: "json",
            url: d,
            ...
            this.gcrud_container.removeClass(b.CLASS_LOADING)
        }.bind(this))
    }, b.prototype.calculationsBeforeDelete = function(a) {
        var c = this,
            d = parseInt(c.gcrud_container.find(".current-total-results").html(), 10),
            e = parseInt(c.gcrud_container.find(".page-number-input").val(), 10),
            f = parseInt(c.gcrud_container.find("." + b.CLASS_PER_PAGE).val(), 10);
        e === c.getMaxPaging() && d - a <= (c.getMaxPaging() - 1) * f && c.gcrud_container.find('input[name="page_number"]').val(c.getMaxPaging() - 1), c.gcrud_container.find(".full-total").html(parseInt(c.gcrud_container.find(".full-total").html(), 10) - a)
    }, b.prototype.listenerDeleteMultiple = function() {
        var b = this;
        b.gcrud_container.find(".select-all-none").click(function() {
            a(this).is(":checked") ? b.gcrud_container.find(".select-row").each(function() {
                a(this).prop("checked", !0), a(this).closest("tr").addClass("warning table-warning")
            }) : b.gcrud_container.find(".select-row").each(function() {
                a(this).prop("checked", !1), a(this).closest("tr").removeClass("warning table-warning")
            }), b.hideShowDeleteButton()
        }), this.gcrud_container.find(".delete-selected-button").click(function() {
            var b;
            this.gcrud_container.find(".delete-multiple-confirmation").gc_modal(), this.gcrud_container.find(".delete-multiple-confirmation").on("hidden.bs.modal", function() {
                ...
                b.preventDefault();
                var c, d = this.gcrud_container.find(".delete-multiple-confirmation:first"),
                    e = [],
                    f = this.gcrud_container.find(".delete-multiple-confirmation-button").data("target");
                this.gcrud_container.find(".select-row:checked").each(function() {
                    e.push(a(this).data("id"))
                }), this.calculationsBeforeDelete(e.length), c = {
                    ids: e
                }, this.sendAjaxPost(c, f, function(b) {
                    b.success ? a.growl(b.success_message, {
                        type: "success",
                        delay: 1e4,
                        animate: {
                            enter: "animated bounceInDown",
                    ...
                    }), d.gc_modal("hide"), this.SearchAndOrderingTrigger()
                }.bind(this))
            }.bind(this))
        }.bind(this))
    }, b.prototype.listenerDeleteRowClick = function(c) {
        var d = this;
        void 0 === c && (c = this.gcrud_container), c.find(".delete-row").click(function(c) {
            c.preventDefault();
            var e = a(this);
            d.gcrud_container.find(".delete-confirmation-button").click(function(c) {
                c.preventDefault();
                var f = d.gcrud_container.find(".delete-confirmation:first");
                d.calculationsBeforeDelete(1), a.ajax({
                    beforeSend: function() {
                        d.gcrud_container.addClass(b.CLASS_LOADING)
                    },
                    error: function() {
                        d.gcrud_container.removeClass(b.CLASS_LOADING)
                    },
                    url: e.data("target"),
                    dataType: "json",
                    success: function(b) {
                        ...
                        }), f.gc_modal("hide"), d.SearchAndOrderingTrigger()
                    }
                })
            }), d.gcrud_container.find(".delete-confirmation").gc_modal(), d.gcrud_container.find(".delete-confirmation").on("hidden.bs.modal", function() {
                d.gcrud_container.find(".delete-confirmation-button").unbind("click")
            })
        })
    }, b.prototype.listenerLoadMoreButton = function() {
        var b = this;
        b.gcrud_container.find("table.grocery-crud-table>tbody .dropdown").on("show.bs.dropdown", function() {
            b.listenerDeleteRowClick(a(this))
        }), b.gcrud_container.find("table.grocery-crud-table>tbody .dropdown").on("hide.bs.dropdown", function() {
            a(this).find(".delete-row").unbind("click")
        })
