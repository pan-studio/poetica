...
Adder.template = [
	...
	'  <button class="print_selected_text d-none d-sm-inline-block btn btn-sm btn-primary shadow-sms" onclick="printSelectedText(this)" type="button"><i class="fa fa-print"></i></button>',
    '</div>'
].join('\n');
...
function injectDynamicStyle() {
    ...
    var rules = [
        ".annotator-adder, .annotator-print, .annotator-outer, .annotator-notice {",
        "  z-index: " + (max + 20) + ";",
        "}",
        ".annotator-filter {",
        "  z-index: " + (max + 10) + ";",
