...
class Annotator {
  constructor(activeDictionary = "cedict") {
    ...
    annotator.numCharsInThisRequest = 0;

    annotator.nodesToAnnotate = [];

    annotator.totalRequests = 0;

    annotator.maxNumCharsPerRequest = 700; // 100 characters per batch

    annotator.seenNodes = [];

    annotator.wordBefore = "";

    annotator.mandBlockID = 0;

    annotator.batches = []; // Batches needs to be done

    annotator.doneBatches = []; // Batches that are done
